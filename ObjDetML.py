        ...
        with tf.Session(graph=detection_graph) as sess:
            if video_file==False:
                ...
                if api_call == True:
                    ...
                    num_of_files_in_dir = len([name for name in os.listdir(DIR) if os.path.isfile(os.path.join(DIR, 
                                                                                                           name))])
                    final_image_path = DIR+'/image'+str(num_of_files_in_dir)+'.png'
                ...
                num_of_files_in_dir = len([name for name in os.listdir(VID_OP_DIR) if os.path.isfile(os.path.join(VID_OP_DIR, 
                                                                                                           name))])
                final_video_path = DIR+'/output_video'+str(num_of_files_in_dir)+'.mp4'
